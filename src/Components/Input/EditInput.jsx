...
const EditInput = ({setInput,placeholder,value}) => {
  return (
    <div className='pt-2 w-full relative'>
     <input type='text'  name='' id='' onChange={(e)=>setInput(e.target.value)}
     className='w-full border-2 border-black rounded-md p-3 pt-4 pb-2 focus:outline-none peer' value={value?value:''} required></input>
